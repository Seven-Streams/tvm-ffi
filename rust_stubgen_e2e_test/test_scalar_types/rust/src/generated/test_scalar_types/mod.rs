...
//! FFI bindings for `test_scalar_types` (generated by tvm-ffi-stubgen).
...
// tvm-ffi-stubgen(begin): object/test_scalar_types.ScalarHolder
#[repr(C)]
pub struct ScalarHolderObj {
    base: Object,
    pub int_val: i64,
    pub float_val: f64,
    pub bool_val: bool,
    pub string_val: tvm_ffi::String,
}

unsafe impl ObjectCore for ScalarHolderObj {
    const TYPE_KEY: &'static str = "test_scalar_types.ScalarHolder";
...
pub struct ScalarHolder {
    data: ObjectArc<ScalarHolderObj>,
}

impl Deref for ScalarHolder {
    type Target = ScalarHolderObj;
    fn deref(&self) -> &ScalarHolderObj {
        &self.data
    }
}

impl DerefMut for ScalarHolder {
    fn deref_mut(&mut self) -> &mut ScalarHolderObj {
        &mut self.data
    }
}
