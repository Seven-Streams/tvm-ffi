...
def _convert_to_ffi_func(pyfunc: Callable[..., Any], tensor_cls: type | None = ...) -> Function: ...
def _convert_to_opaque_object(pyobject: Any) -> OpaquePyObject: ...
def _print_debug_info() -> None: ...
def _register_py_class(parent_type_info: TypeInfo, type_key: str, type_cls: type) -> TypeInfo: ...
def _register_fields(type_info: TypeInfo, fields: list[Any]) -> list[TypeField]: ...
...
# ---------------------------------------------------------------------------
# Owned FFI value container (from cython/object.pxi)
# ---------------------------------------------------------------------------
...
def _to_py_class_value(value: CAny) -> Any: ...
...
class TypeInfo:
    ...
    def _register_fields(self, fields: list[Any]) -> None: ...
