...
#: Rust strict keywords that, used as a generated field/method identifier, need
#: a raw identifier (``r#name``). A few (``self``/``Self``/``super``/``crate``)
#: cannot be raw identifiers and are handled separately.
